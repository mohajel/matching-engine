...
public class OrderHandler {
    ...
    final MatchingControlList controls;

    public OrderHandler(SecurityRepository securityRepository, BrokerRepository brokerRepository, ShareholderRepository shareholderRepository, EventPublisher eventPublisher, Matcher matcher, MatchingControlList controls) {
    ...
    public void handleEnterOrder(EnterOrderRq enterOrderRq) {
        try {
            ...
            if (enterOrderRq.getRequestType() == OrderEntryType.NEW_ORDER)
                matchResult = new NewOrderProcessor(controls, matcher, enterOrderRq, security, broker, shareholder).processCommand();
            else
                matchResult = new UpdateOrderProcessor(controls, matcher, enterOrderRq, security).processCommand();
    ...
    public void handleDeleteOrder(DeleteOrderRq deleteOrderRq) {
        try {
            ...
            new DeleteOrderProcessor(controls, deleteOrderRq, security).processCommand();
